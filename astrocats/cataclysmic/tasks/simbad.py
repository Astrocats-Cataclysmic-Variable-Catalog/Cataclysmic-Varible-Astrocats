...
def do_simbad(catalog):
    ...
    simbadbadnamebib = ['2004AJ....127.2809W', '2005MNRAS.364.1419Z',
                        ...
                        'url:GPSA','url:IAUC','url:vsnet',]
    badurlbibname = ['url:TNS','url:ASASSN','url:Lasair','url:AAVSO','url:IAUC','url:vsnet']
...
#        print(row)
		...
		csources = ','.join([source, catalog.entries[name].add_source(bibcode=row['COO_BIBCODE'])])
